...
export default function BottomCapabilitiesList({ pageData, bottomCapabilitiesList }) {
    
    return (
        <Section>
            <Wrapper>
                <VerticalBox>
                    <h6 className="vertical-title-light">{bottomCapabilitiesList.acf.capabilities.vertical_title}</h6>
                </VerticalBox>
                <ContentWrapper>
                {bottomCapabilitiesList.acf.capabilities.content_box.map((item, index) => {
